...
window["onEvent"] = function (payload) {
    logger("external")("Event from child microapp i.e. \"microapp2\" through onEvent event listenter!")(payload);
}
...
requestButton.addEventListener("click", function () {
    ...
    window.JOS.emitEventWithLog('microapp2')("onMerchantEvent")(["process", JSON.stringify(payload)])(success)();
});